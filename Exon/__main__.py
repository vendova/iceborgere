...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="Network", url="https://t.me/WerewolfNetworks"),
    ],
]
        ...
        if args and len(args) >= 1:
            if args[0].lower() == "help":
                ...
                if isinstance(help_list, list):
                    ...
                    help_text = help_list
                text = (
                    "Here is the help for the *{}* ᴍᴏᴅᴜʟᴇ:\n".format(
    ...
    if len(args) >= 2:
        if any(args[1].lower() == x for x in HELPABLE):
            ...
            if isinstance(help_list, list):
                ...
                help_text = help_list
            text = (
                "Here is the available help for the *{}* ᴍᴏᴅᴜʟᴇ:\n".format(
                    HELPABLE[module].__mod_name__
                )
                + help_text
            )
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                ...
                caption=f"""
ㅤ{dispatcher.bot.first_name} Is ALIVE ✨ .....
...
""",
    ...
    log.info(
        f"Using long polling. ........... ᴇɴᴊᴏʏ ʏᴏᴜʀ ʙᴏᴛ sᴛᴀʀᴛᴇᴅ ᴀs →  {dispatcher.bot.first_name} "
    )
